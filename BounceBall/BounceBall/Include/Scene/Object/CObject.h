...
public:
	CObject(Types::ObjectType type, Types::ObjectState state = Types::OS_IDLE, 
		Types::Direction dir = Types::DIR_IDLE, Types::Point point = { 0, 0 });
	virtual ~CObject();
...
public:
	...
	void SetObjectPointY(float y) { if (y>0) m_fObjectPoint = y; }
